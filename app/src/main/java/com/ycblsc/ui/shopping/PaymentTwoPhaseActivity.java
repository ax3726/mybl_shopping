...
public class PaymentTwoPhaseActivity extends BaseActivity<BasePresenter, ActivityPayBinding> implements View.OnClickListener {
    ...
    protected void initEvent() {
        ...
        String str = (String) SharedPreferencesUtils.getParam(PaymentTwoPhaseActivity.this, "pay", "");
        //蚁巢会员支付
    ...
    private void WexPay() {
        ...
        Api.getApi2().getWexPay2(userId, "010203", shopCount, shopId, shopPrice, MyApplication.getInstance().getmShoppingId(), MyApplication.getInstance().getShouhuoid())
    ...
    private void AliPay() {
        ...
        Api.getApi2().getPay2(userId, "010202", shopCount, shopId, shopPrice, MyApplication.getInstance().getmShoppingId(), MyApplication.getInstance().getShouhuoid())
                .compose(callbackOnIOToMainThread())
    ...
    * */
    private void initPayMethod() {
        Api.getApi2().getPay2(CacheService.getIntance().getUserId(), "010207", shopCount, shopId, shopPrice, MyApplication.getInstance().getmShoppingId(), MyApplication.getInstance().getShouhuoid())
                .compose(callbackOnIOToMainThread())
                .subscribe(new BaseNetSubscriber<BaseBean>(true) {
                    @Override
                    public void onNext(BaseBean baseBean) {
